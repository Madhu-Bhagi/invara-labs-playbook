...
- Approved Chapter 03 — Vision Statement.
- Final vision statement and vision summary.

### Confirmed

- Globally trusted rather than ranking-based vision language.
- Thoughtfully applied AI within an engineering-first identity.
- Chapter 04 — Core Values as the next foundation chapter.

## [1.2.0] — 27 July 2026

### Added

- Approved Chapter 02 — Mission Statement.
- Customer Promise.
- Core Service Areas.
...
- Founder Journal.
- AI and Codex workspace guidance.
- Knowledge map and documentation index.

### Confirmed

- Engineering-first, AI-enabled, business-focused positioning.
- Business-problem-first company identity.
...
- Approved Chapter 01 — Founder Vision.
- Founder philosophy and non-negotiables.
- Systems-over-heroes engineering principle.
